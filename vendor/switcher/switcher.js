...
function setThemeLogo(themeOptionItemAttr){
	...
	if(logo != ''){
		...
		jQuery(".logo-white a img").attr("src", logo);
		jQuery(".logo-dark a img").attr("src", logo);
